...
const DEFAULT_LIST = [
  { name: 'Nigar A.', text: 'Atmosfer zərif, servis diqqətlidir. Plov və kabablar balanslı idi.' },
  { name: 'Rauf M.', text: 'Yeni Bulvarın sakit hissəsində, dəniz kənarında zövqlü axşam üçün ideal məkandır.' },
...
const Testimonials = () => {
  ...
  return (
    <section className="section-padding bg-[#f3ecdf] pt-12 pb-12 sm:pt-16 sm:pb-16">
