...
import heroVideo from '../assets/boulevard-atmospher (1).mp4'
      ...
      <div className="container-layout relative z-10 grid items-center gap-12 py-28 md:grid-cols-[1.1fr,0.9fr]">
        <div>
          ...
          <RevealOnScroll from="up" delayClass="delay-150">
            <h1 className="font-serif text-4xl tracking-[0.12em] text-lightBg sm:text-5xl md:text-[3.25rem]">
              BOULEVARD 1909
            </h1>
          </RevealOnScroll>
          ...
          <RevealOnScroll from="up" delayClass="delay-300">
            <div className="mt-8 flex flex-col items-stretch gap-3 sm:flex-row sm:items-center sm:gap-4">
              ...
              <button onClick={goMenu} className="btn-secondary">
                {t('hero.ctaMenu')}
              </button>
            </div>
          </RevealOnScroll>
